...
/**
 * Scm_mrp_t_mrppab entity. @author MyEclipse Persistence Tools
 */

public class Scm_mrp_t_mrppab implements java.io.Serializable {

	// Fields

	private Long mrppab_id;
	...
	/** default constructor */
	public Scm_mrp_t_mrppab() {
	}

	/** full constructor */
	public Scm_mrp_t_mrppab(Long mrpparam_fk, Timestamp mrpdate,
	...
	public Long getMrppab_id() {
		return this.mrppab_id;
	}

	public void setMrppab_id(Long mrppab_id) {
		this.mrppab_id = mrppab_id;
	}
