...
/**
 * Scm_mrp_t_mrpnr entity. @author MyEclipse Persistence Tools
 */

public class Scm_mrp_t_mrpnr implements java.io.Serializable {

	// Fields

	private Long mrpnr_id;
	...
	/** default constructor */
	public Scm_mrp_t_mrpnr() {
	}

	/** full constructor */
	public Scm_mrp_t_mrpnr(Long mrpparam_fk, Timestamp mrpdate,
	...
	public Long getMrpnr_id() {
		return this.mrpnr_id;
	}

	public void setMrpnr_id(Long mrpnr_id) {
		this.mrpnr_id = mrpnr_id;
	}
