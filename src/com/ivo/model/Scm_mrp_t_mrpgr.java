...
/**
 * Scm_mrp_t_mrpgr entity. @author MyEclipse Persistence Tools
 */

public class Scm_mrp_t_mrpgr implements java.io.Serializable {

	// Fields

	private Long mrpgr_id;
	...
	/** default constructor */
	public Scm_mrp_t_mrpgr() {
	}

	/** full constructor */
	public Scm_mrp_t_mrpgr(Long mrpparam_fk, Timestamp mrpdate,
	...
	public Long getMrpgr_id() {
		return this.mrpgr_id;
	}

	public void setMrpgr_id(Long mrpgr_id) {
		this.mrpgr_id = mrpgr_id;
	}
