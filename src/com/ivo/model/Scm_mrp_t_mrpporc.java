...
/**
 * Scm_mrp_t_mrpporc entity. @author MyEclipse Persistence Tools
 */

public class Scm_mrp_t_mrpporc implements java.io.Serializable {

	// Fields

	private Long mrpporc_id;
	...
	/** default constructor */
	public Scm_mrp_t_mrpporc() {
	}

	/** full constructor */
	public Scm_mrp_t_mrpporc(Long mrpparam_fk, Timestamp mrpdate,
	...
	public Long getMrpporc_id() {
		return this.mrpporc_id;
	}

	public void setMrpporc_id(Long mrpporc_id) {
		this.mrpporc_id = mrpporc_id;
	}
