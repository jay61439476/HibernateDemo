...
/**
 * Scm_mrp_t_mrppor entity. @author MyEclipse Persistence Tools
 */

public class Scm_mrp_t_mrppor implements java.io.Serializable {

	// Fields

	private Long mrppor_id;
	...
	/** default constructor */
	public Scm_mrp_t_mrppor() {
	}

	/** full constructor */
	public Scm_mrp_t_mrppor(Long mrpparam_fk, Timestamp mrpdate,
	...
	public Long getMrppor_id() {
		return this.mrppor_id;
	}

	public void setMrppor_id(Long mrppor_id) {
		this.mrppor_id = mrppor_id;
	}
