...
/**
 * Scm_mrp_t_mrpsr entity. @author MyEclipse Persistence Tools
 */

public class Scm_mrp_t_mrpsr implements java.io.Serializable {

	// Fields

	private Long mrpsr_id;
	...
	/** default constructor */
	public Scm_mrp_t_mrpsr() {
	}

	/** full constructor */
	public Scm_mrp_t_mrpsr(Long mrpparam_fk, Timestamp mrpdate,
	...
	public Long getMrpsr_id() {
		return this.mrpsr_id;
	}

	public void setMrpsr_id(Long mrpsr_id) {
		this.mrpsr_id = mrpsr_id;
	}
